      ...
      >
        {Children.map(children, (tab, index) => (
          <motion.button
            ...
            className={clsx(
              "py-2 px-2 text-left focus:bg-stone-200 dark:focus:bg-stone-400 focus:outline-hidden hover:bg-stone-200 dark:hover:bg-stone-400 border-b-2 md:border-b-0 md:border-l-2",
              {
                "border-transparent": index !== activeIndex,
                "border-black dark:border-white": index === activeIndex,
                "font-bold": index === activeIndex,
                "bg-stone-300 focus:bg-stone-300 dark:bg-stone-600 dark:focus:bg-stone-400":
                  index === activeIndex,
              },
            )}
            whileHover={{
