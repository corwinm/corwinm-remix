      ...
      >
        {Children.map(children, (tab, index) => (
          <motion.button
            ...
            className={clsx(
              "py-2 px-2 text-left focus:bg-stone-200 focus:dark:bg-stone-400 focus:outline-none hover:bg-stone-200 hover:dark:bg-stone-400 border-b-2 md:border-b-0 md:border-l-2",
              {
