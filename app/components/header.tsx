...
const Header: FunctionComponent<HeaderProps> = ({ siteTitle = `` }) => {
  ...
  return (
    <header className="sticky top-0 z-50 print:hidden backdrop-blur-md bg-white/30 dark:bg-stone-800/30 mb-6 shadow-[0_4px_6px_-1px_rgba(147,51,234,0.1),0_2px_4px_-2px_rgba(239,68,68,0.1)]">
