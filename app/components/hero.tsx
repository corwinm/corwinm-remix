  ...
  return (
    <section className="my-6 text-center md:text-left">
      <h1 className="text-transparent text-4xl md:text-8xl font-bold">
        <motion.span
          className="block pt-2 pb-4 bg-clip-text bg-linear-to-r from-indigo-500 to-red-500"
        ...
        <motion.span
          className="block pb-4 bg-clip-text bg-linear-to-r from-indigo-500 to-red-500"
          initial={{ scale: 1.5, opacity: 0 }}
          animate={{ scale: 1, opacity: 1 }}
