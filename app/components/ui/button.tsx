  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full font-medium transition-all duration-300 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive active:scale-95",
  {
    variants: {
      variant: {
        ...
        gradient:
          "bg-gradient-to-r from-indigo-400 to-indigo-300 text-white shadow-lg hover:shadow-[0_0_25px_rgba(129,140,248,0.45)] transition-shadow",
        destructive:
          "bg-destructive text-white shadow-xs hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40",
        outline:
          "bg-transparent border-2 border-indigo-400 text-indigo-400 dark:text-white hover:bg-indigo-400 hover:text-white",
        secondary:
      ...
      size: {
        default: "font-bold px-6 py-3 has-[>svg]:px-6",
        sm: "h-8 gap-1.5 px-3 has-[>svg]:px-2.5",
        lg: "font-bold px-6 py-3 has-[>svg]:px-4",
        icon: "size-9",
      },
    },
    defaultVariants: {
